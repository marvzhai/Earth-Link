  ...
  return (
    <div className="space-y-8">
      {posts.map((post, index) => (
        <article
          key={post.id}
          className="bg-white border border-stone-200 rounded-lg p-8 hover:border-stone-300 transition-colors"
        >
          {/* Header */}
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-3">
              {/* Simple Avatar */}
              <div className={`w-10 h-10 rounded-full ${getColor(index)} flex items-center justify-center text-white font-medium text-sm`}>
              ...
              <div>
                ...
                <div className="flex items-center text-sm text-stone-500 mt-0.5">
          ...
          {/* Post Content */}
          <div className="text-stone-700 leading-relaxed whitespace-pre-wrap break-words mb-6">
            {post.body}
          </div>
